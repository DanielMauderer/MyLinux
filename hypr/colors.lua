-- Material You palette generated by matugen (see matugen/templates/hyprland_colors.lua.tmpl).
-- Regenerate with: hypr/scripts/apply_matugen.sh [WALLPAPER]
...
-- pywal-style aliases kept for compatibility with the old hyprland.conf
colors.color8  = colors.on_primary_fixed
colors.color11 = colors.on_surface
